...
Qobuz stopped accepting email and password from third-party clients in April 2026, so the
account token has to be copied from a logged-in browser session: see "qoget login -h".
`
